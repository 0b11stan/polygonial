...
void MainWindow::on_pushButton_clicked()
{
    ...
    int chosen_same_length_sides = ui->cb_same_length_sides->currentText().toInt();
    ...
    Record record(chosen_sides, chosen_right_angles, chosen_parallel_sides, chosen_same_length_sides);
